...
load_test_put:
	oha -n 100000 -m PUT -d '{"collection_name": "collection1", "embedding": {"id" : {"unique_id": "1"}, "vector" :[0.14, 0.316, 0.433], "metadata": {"key1": "value1", "key2": "value2"}}}' http://127.0.0.1:8000/insert_embeddings
